                    ...
                    <form id="form-order-detail" class="product_insert-form" method="POST" enctype="multipart/form-data" role="form">
                                    ...
                                    <div class="main-form_right">
                                        ...
                                        <div class="form-input">
                                            ...
                                            <input <?php if ($order['TrangThaiDH'] != '0') {
                                                        ...
                                                        echo 'type="date"';
                                                    } ?> class="form_input input_readonly" id="fname" name="order_delivery" value="<?php echo date_format(date_create($order['NgayGH']), 'd-m-Y') ?>">
                                        </div>
                                        <div class="form-input">
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                    <tr>
                                                        ...
                                                        <!-- Giảm giá -->
                                                        <td>
                                                            <input type="text" name="saleoff<?php echo $order_prd['MSSP']; ?>" value="<?php echo number_format($order_prd['GiamGia'], 0, ',', '.'); ?>" <?php if ($status != 0) {echo 'class="tb_input input_readonly" readonly';} else {echo 'class="tb_input"';}?> >
                                                        </td>
                        ...
                        <?php if ($status == "0") { ?>
                            <div class="order_detail-control">
                                ...
                                <button value="<?php echo $order['SoDonDH']; ?>" class="button button-dangerous order_btn-del">Hủy đơn hàng</button>
                            </div>
                            <?php } else {
                            if ($status == "1") { ?>
