                ...
                <div class="product_insert-content">
                    ...
                    <div class="order-title">
                        <span class="order_title">
                            ...
                            <?php if($status==0){echo "Đơn hàng chờ xử lý:";
                                }else{
                                    if($status==1){echo"Đơn hàng đã xử lý:";
                                    }else{echo "Đơn hàng chờ thanh toán:";}
                                }?>
                        </span>
                    </div>
                                                ...
                                                ?>
                                                    ...
                                                    <!-- STT -->
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if($status!=0){echo 'class="tb_input input_readonly" readonly';
