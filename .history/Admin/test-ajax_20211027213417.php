                        ...
                        <div class="main_form">
                                <div class="main-form_left">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <textarea type="text" class="form_input form_textarea" id="fname" name="product_description"><?php echo $product['MoTa'] ?></textarea>
                                    </div>
                                    <div class="form-input">
                                ...
                                <div class="main-form_right">
                                    ...
                                    <div class="form-input">
                                        <label class="form_label" for="fname">Kinh doanh</label>
