        ...
        <div class="grid_full-width wrapper">
            ...
            <div class="container">
                ...
                <div class="product_insert-content">
                    <form id="form-order-detail" class="product_insert-form" method="POST" role="form">
                        ...
                        <?php if ($status == "0") { ?>
                            <div class="order_detail-control">
                                <button type="submit" class="button form-success_btn order-btn" name="submit">Xác nhận đơn hàng</button>
                                <!-- <button type="submit" class="button form-success_btn order-btn" name="submit" onclick="return validateOrderDelivery();">Xác nhận đơn hàng</button> -->
                                <!-- <div id="del-order" value="<?php echo $order_id; ?>" class="button button-dangerous order_btn-del">Hủy đơn hàng</div> -->
                            </div>
                            <?php } else {
                            if ($status == "1") { ?>
                                <!-- <button type="submit" class="button form-success_btn order-btn" name="submit">Hoàn thành đơn hàng</button> -->
                        <?php }
                        } ?>
                    </form>
                </div>
