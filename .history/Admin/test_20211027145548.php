...
if (isset($_GET['ins-prd'])) {
    ...
    if (isset($_POST['product_name']) && isset($_POST['product_price']) && isset($_POST['product_quantity']) && isset($_POST['product_image'])) {
        ...
        if (isset($_POST['camera']) && isset($_POST['camera_selfie'])) {
            $camera_selfie = (!empty($_POST['camera_selfie']))? $_POST[''] : 'Chưa rõ';
            $camera = (!empty($_POST['camera']))? $_POST[''] : 'Chưa rõ';
        ...
        if (isset($_POST['ram'])) {
            $ram = (!empty($_POST['ram']))? $_POST[''] : 'Chưa rõ';
        ...
        if (isset($_POST['rom'])) {
            $rom = (!empty($_POST['rom']))? $_POST[''] : 'Chưa rõ';
        ...
        if (isset($_POST['cpu'])) {
            $cpu = (!empty($_POST['cpu']))? $_POST[''] : 'Chưa rõ';
        ...
        if (isset($_POST['scrgpueen'])) {
            $gpu = (!empty($_POST['gpu']))? $_POST[''] : 'Chưa rõ';
        ...
        if (isset($_POST['battery'])) {
            $battery = (!empty($_POST['battery']))? $_POST[''] : 'Chưa rõ';
        ...
        if (isset($_POST['sim'])) {
            $sim = (!empty($_POST['sim']))? $_POST[''] : 'Chưa rõ';
        ...
        if (isset($_POST['os'])) {
            $os = (!empty($_POST['os']))? $_POST[''] : 'Chưa rõ';
