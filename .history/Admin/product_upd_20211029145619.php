        ...
        <div class="grid_full-width wrapper">
            ...
            <div class="container">
                ...
                <div class="main_insert-content">
                    ...
                    <!-- <form action="test.php?upd-prd" class="product_insert-form" method="POST" enctype="multipart/form-data" role="form"> -->
                        ...
                        <div class="main_form">
                                <div class="main-form_left">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <textarea type="text" class="form_input form_textarea" name="product_description"><?php echo $product['MoTa'] ?></textarea>
                                    </div>
                                    <div class="form-input">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <input type="text" class="form_input" name="product_sale" value="<?php echo number_format($product['GiaBan'], 0, ',', '.') ?>">
                                    </div>
                                    <div class="form-input">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <input type="text" class="form_input" name="product_madein" value="<?php echo $product['XuatXu'] ?>">
                                    </div>
                                </div>
                                <div class="main-form_right">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <input type="text" class="form_input" name="product_debuts" value="<?php echo $product['NgayRaMat'] ?>">
                                    </div>
                                    <div class="form-input">
                                    ...
                                    <div class="form-input">
                                        <label class="form_label">Kinh doanh</label>
                                        <select class="form_input" name="product_status">
                                            <option value="<?php echo $product['TrangThai']?>"><?php if($product['TrangThai']==1){echo "Kinh doanh";} else{echo "Ngừng kinh doanh";}?></option>
