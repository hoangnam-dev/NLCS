...
if (isset($_GET['ins-prd'])) {
    ...
    if (isset($_POST['product_name']) && isset($_POST['product_price']) && isset($_POST['product_quantity']) && isset($_POST['product_image'])) {
        ...
        if ($rs1) {
            ...
            $sql_screen = "INSERT INTO `ManHinh` (`id`, `KichThuoc`, `MSSP`) VALUES (NULL, '$screen', '$last_id'); ";
            $rs_screen = mysqli_query($conn, $sql_screen);
            
            $sql_selfie = "INSERT INTO `ManHinh` (`id`, `KichThuoc`, `MSSP`) VALUES (NULL, '$selfie', '$last_id'); ";
            $rs_selfie = mysqli_query($conn, $sql_selfie);
