...
<body>
        ...
        <div class="grid_full-width wrapper">
            ...
            <div class="container">
                ...
                <div class="main_insert-content">
                    ...
                    <form id="from-ins-prd" action="./process.php?ins-prd" class="product_insert-form" method="POST" enctype="multipart/form-data">
                        <div class="main_form">
                            <div class="main-form_left">
                                ...
                                <div class="form-input">
                                    ...
                                    <input id="input-img" type="hidden" class="form_input" name="image_name">
                                    <input id="file-img" type="file" class="form_input" name="image_name">
                                </div>
                            </div>
    ...
    <script>
        ...
        //     var file_data= $("#from-ins-prd").prop('files')[0];
        //     // Khởi tạo form data
