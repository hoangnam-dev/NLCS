...
if (isset($_GET['ins-prd'])) {
    ...
    if (isset($_POST['product_name']) && isset($_POST['product_price']) && isset($_POST['product_quantity']) && isset($_POST['product_image'])) {
        ...
        if ($rs1) {
            ...
            $sqlcamera = "INSERT INTO `Camera` (`id`, `CameraTruoc`, `CameraSau`, `MSSP`) VALUES (NULL, '$camera_selfie', '$camera_back', '$last_id'); ";
            ...
            $sqlpin = "INSERT INTO `Pin` (`id`, `DungLuong`, `MSSP`) VALUES (NULL, '$pin', '$last_id'); ";
