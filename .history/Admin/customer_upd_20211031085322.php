...
<body>
        ...
        <div class="grid_full-width wrapper">
            ...
            <div class="container">
                ...
                <div class="customer_insert-content">
                    <form id="form-upd-customer" class="customer_insert-form" method="POST" role="form">
                        <div class="main_form">
                            <?php $customer = mysqli_fetch_assoc($rs) ?>
                            <div class="main-form_left">
                                <div class="form-input">
                                    <label class="form_label">Mã số khách hàng:</label>
                                    <input type="text" class="form_input disable-input" id="fname" name="customer_id" readonly="true" value="<?php echo $customer['MSKH'] ?>">
                                </div>
                                <div class="form-input">
                                    <label class="form_label">Tên khách hàng:</label>
                                    <input type="text" class="form_input" id="customer_name" name="customer_name" value="<?php echo $customer['HoTenKH'] ?>">
                                    <span id="error-customer_name" class="error-message"></span>
                                </div>
                                <div class="form-input">
                                    <label class="form_label">Đia chỉ</label>
                                    <input type="text" class="form_input" id="customer_address" name="customer_address" value="<?php echo $customer['DiaChi'] ?>">
                                    <span id="error-customer_address" class="error-message"></span>
                                </div>
                                <div class="form-input">
                                    <label class="form_label">Gioi tính:</label>
                                    <input type="text" class="form_input" id="customer_sex" name="customer_sex" value="<?php echo $customer['GioiTinh'] ?>">
                            ...
                            <div class="main-form_right">
                                <div class="form-input">
                                    ...
                                    <input type="text" class="form_input" id="customer_phone" name="customer_phone" value="<?php echo $customer['SoDienThoai'] ?>">
                                    <span id="error-customer_phone" class="error-message"></span>
                                </div>
                                <div class="form-input">
                                    <label class="form_label">Email:</label>
                                    <input type="text" class="form_input" id="customer_email" name="customer_email" value="<?php echo $customer['Email'] ?>">
                                    <span id="error-customer_email" class="error-message"></span>
                                </div>
                                <div class="form-input">
                                    <label class="form_label">Mật khẩu:</label>
                                    <input type="text" class="form_input" id="customer_password" name="customer_password" value="<?php echo $customer['MatKhau'] ?>">
    ...
    <script>
        ...
        function validateCustomer() {
            ...
            var repassword =$("#customer_repassword").val();
