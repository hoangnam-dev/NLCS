                            ...
                            <?php while ($product = mysqli_fetch_array($rs)) { ?>
                                <div class="main-form_left">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <input type="text" class="form_input" id="fname" name="product_price" value="<?php echo number_format($product['GiaBan'], 0, ',', '.') ?>">
                                    </div>
                                    <div class="form-input">
                                ...
                                <div class="main-form_right">
                                    ...
                                    <div class="form-input">
                                        ...
                                        <input type="file" class="form_input" name="image_newname">
                                    </div>
                                    <div class="form-input">
