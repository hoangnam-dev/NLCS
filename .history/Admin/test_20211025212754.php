...
if (isset($_GET['ins-prd']) &&$_GET['ins-prd']=='ins-prd') {
    echo "oke";exit;
    if ( isset($_POST['submit'])&& isset($_POST['product_name']) && isset($_POST['product_price']) && isset($_POST['product_quantity']) && isset($_POST['product_category']) && isset($_POST['product_brand'])) {
