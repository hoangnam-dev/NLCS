...
if (isset($_GET['upd-prd'])) {
    if (isset($_POST['product_name']) && isset($_POST['product_price']) && isset($_POST['product_quantity'])) {
        ...
        $sql = "UPDATE SanPham SET TenSP='$product_name', MoTa='$product_description', Gia='$product_price', GiaBan='$product_sale', Avatar='$product_img', SoLuongHang='$product_quantity', NgayRaMat='$product_debuts', XuatXu='$product_madein', MLSP='$product_category', MSTH='$product_brand'";
        $rs = mysqli_query($conn, $sql);
