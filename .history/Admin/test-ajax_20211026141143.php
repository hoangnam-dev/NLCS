...
<body>
                    ...
                    <!-- <form id="from-ins-prd" action="./test.php?ins-prd" class="product_insert-form" method="POST" enctype="multipart/form-data"> -->
                        <div class="main_form">
                            ...
                            <div class="main-form_right">
                                <form id="form-prd-img" method="post">
                                    <div class="form-input">
                                        ...
                                        <input type="submit" class="button button-s form-success_btn" name="submit" value="Upload ảnh">
                                    </div>
                                    <!-- <div class="showimg">
    ...
    <script>
        ...
        // Ajax
        // Upload Image
        // $("#form-prd-img").submit(function(event) {
        ...
        // // Insert Product
        // $("#from-prd-img").submit(function(event) {
        //     event.preventDefault();
        //     $.ajax({
        //         type: "POST",
