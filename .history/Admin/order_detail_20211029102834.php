                                ...
                                <div class="main_form">
                                    ...
                                    <div class="main-form_right">
                                        ...
                                        <div class="form-input">
                                            ...
                                            <input type="<?php if($order['TrangThaiDH']!='0'){echo "text"}else{echo "date"}?>" class="form_input" id="fname" name="order_delivery" value="<?php echo date_format(date_create($order['NgayGH']),'d-m-Y')?>">
                                        </div>
                                        <div class="form-input">
