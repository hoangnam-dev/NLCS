                            ...
                            <table class="main-table_content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="btn-edit">
                                            <a href="customer_upd.php?id=<?php echo $customer['MSKH']; ?>" class="button-edit btn-update">Chi tiết</a>
                                            <button class="button-edit btn-delete" value="<?php echo $customer['MSKH'];?>">Xóa</button>
                                        </td>
                                    </tr>
                                    <?php $i++;}?>
                                </tbody>
