...
<body>
                    ...
                    <form id="form-order-detail" class="product_insert-form" method="POST" enctype="multipart/form-data" role="form">
                                ...
                                <div class="main_form">
                                    ...
                                    <div class="main-form_right">
                                        ...
                                        <div class="form-input">
                                            ...
                                            class="form_input input_readonly" id="delivery_ord" name="order_delivery" value="<?php echo date_format(date_create($order['NgayGH']), 'd-m-Y') ?>" >
                        ...
                        <?php if ($status == "0") { ?>
                            <div class="order_detail-control">
                                ...
                                <button id="confirm-order" value="<?php echo $order_id; ?>" class="button form-success_btn order-btn">Xác nhận đơn hàng</button>
                                <button id="del-order" value="<?php echo $order_id; ?>" class="button button-dangerous order_btn-del">Hủy đơn hàng</button>
                            </div>
                            <?php } else {
                            if ($status == "1") { ?>
                                <button id="confirm-order" value="<?php echo $order_id; ?>" class="button form-success_btn order-btn">Hoàn thành đơn hàng</button>
                        <?php }
                        } ?>
                    </form>
                </div>
    ...
    <script>
        ...
        $("#confirm-order").click(function(event) {
            var id = $(this).val();
            var delivery_ord = $("#delivery_ord").val();
            if(delivery_ord == ""){
