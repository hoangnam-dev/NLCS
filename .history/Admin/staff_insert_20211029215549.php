                ...
                <div class="main_insert-content">
                        <form action="process.php?action=add-staff" class="staff_insert-form" method="POST" role="form">
                            ...
                            <div class="form-input">
                                ...
                                <input id="staff_name" type="text" class="form_input" name="staff_post">
                            </div>
                            <div class="form-input">
                                <label class="form_label" for="fname">Địa chỉ(*):</label>
                                <input id="staff_name" type="text" class="form_input" name="staff_address">
                            </div>
                            <div class="form-input">
                                <label class="form_label" for="fname">Số điện thoại(*):</label>
                                <input id="staff_name" type="text" class="form_input" name="staff_phone">
                            </div>
                            <div class="form-input">
                                <label class="form_label" for="fname">Mật khẩu(*):</label>
                                <input id="staff_name" type="text" class="form_input" name="staff_password">
                            </div>
                            <div class="form-input">
                                <label class="form_label" for="fname">Mật khẩu(*):</label>
                                <input id="staff_name" type="text" class="form_input" name="staff_password">
