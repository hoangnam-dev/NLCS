        ...
        while($data = mysqli_fetch_array($rs)) {
            ...
            if($data['TrangThai']!='completed'){
               // Tìm CTDH cần update SL
                ...
                //         $rs_del_ord = mysqli_query($conn, $sql);
                //         $flag = true;
                //     }
                // }
                echo json_encode(array (
...
if(isset($_GET['order-comfirm'])){
    if (isset($_POST['order_id'])&&isset($_POST['order_date'])&&isset($_POST['order_delivery'])&&isset($_SESSION['admin'])) {
        ...
        $order_date = date_create($_POST['order_date']);
        $order_delivery = date_create($_POST['order_delivery']);
...
if (isset($_GET['order-complete']) && isset($_GET['id']) && isset($_SESSION['admin'])) {
    $order_id = $_GET['id'];
    $admin_id = $_SESSION['admin']['MSNV'];
