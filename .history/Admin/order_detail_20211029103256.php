                                ...
                                <div class="main_form">
                                    ...
                                    <div class="main-form_right">
                                        ...
                                        <div class="form-input">
                                            ...
                                            <input type="text" class="form_input" id="fname" name="order_date" readonly value="<?php echo date_format(date_create($order['NgayDH']),'d-m-Y')?>">
                                        </div>
                                        <div class="form-input">
                                            ...
                                            <input
                                            <?php if($order['TrangThaiDH']!='0'){echo 'type="text" readonly';}else{echo 'type="date"';}?>
                                            class="form_input" id="fname" name="order_delivery" value="<?php echo date_format(date_create($order['NgayGH']),'d-m-Y')?>">
                                        </div>
                                        <div class="form-input">
