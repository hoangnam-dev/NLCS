        ...
        <div class="grid_full-width wrapper">
            ...
            <div class="container">
                ...
                <div class="category_insert-content">
                    <form action="process.php?action=update-category&id=<?php echo $category['MLSP'] ?>" class="category_insert-form" method="POST" role="form">
                        <div class="main_form-s">
                            <div class="form-input">
                                <label class="form_label" for="fname">Mã loại sản phẩm:</label>
                                <input type="text" class="form_input disable-input" id="fname" name="category_id" readonly="true" value="<?php echo $category['MLSP'] ?>">
                            </div>
                            <div class="form-input">
                                <label class="form_label" for="fname">Tên loại sản phẩm:</label>
                                <input type="text" class="form_input" id="fname" name="category_name" value="<?php echo $category['TenLSP'] ?>">
                            </div>
                        </div>
