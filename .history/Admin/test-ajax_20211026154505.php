                        ...
                        <div class="main_form">
                            <div class="main-form_left">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" class="form_input" name="camera_back">
                                </div>
                                <div class="form-input">
                                ...
                                <div class="form-input">
                                    ...
                                    <input type="text" class="form_input" name="pin">
                                </div>
                            </div>
                            <div class="main-form_right">
                                <div class="form-input">
                                ...
                                <div class="form-input">
                                    ...
                                    <input id="input-img" type="text" class="ram" name="product_image" value="">
                                </div>
                                <div class="form-input">
                                ...
                                <div class="form-input">
                                    ...
                                    <input id="input-img" type="text" class="sim" name="product_image" value="">
                                </div>
                            </div>
                        </div>
