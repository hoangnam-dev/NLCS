...
<body>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="btn-edit">
                                            ...
                                            <button id="del-staff-<?php echo $staff['MSNV'];?>" class="button-edit btn-delete" value="<?php echo $staff['MSNV'];?>">Xóa</button>
    ...
    <script>
        ...
        $("#del-staff").click(function(event) {
            var id =$("#del-staff-<?php echo $staff['MSNV'];?>").val();
            alert(id);
            event.preventDefault();
            $.ajax({
                type: "POST",
                url: "./process.php?del-staff",
                data: (id=>'<?php echo $staff['MSNV'];?>'),
