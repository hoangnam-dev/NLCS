                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="./process.php?stt-prd&id=<?php echo $product['MSSP']?>&stt=0" class="check">
                                                <i class="prd-icon fas fa-check-circle"></i>
                                            </a>
                                            <?php }else{?>
                                            <a id="del_<?php echo $product['MSSP']?>" href="./process.php?stt-prd&id=<?php echo $product['MSSP']?>&stt=1" class="exit">
                                            <!-- <a href="./process.php?stt-prd&id=<?php echo $product['MSSP']?>&stt=1" class="exit">
    ...
    <script>
        function stt_prd(id,status){
            $.ajax({
                ...
                data: {id:id,stt:status}, // Gửi dữ liệu của form
