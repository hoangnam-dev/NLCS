                ...
                <div class="grid_row main_content">
                    ...
                    <div class="grid_col-9 ctn-box ctn-mb">
                        ...
                        <div class="ctn_filter">
                            ...
                            <button class="button ctn_btn category_tab-active" data-ajax="hot_product.php">Phổ biến</button>
                            <button class="button ctn_btn" data-ajax="hot_product.php">Mới nhất</button>
