...
<html lang="en">
  <head>
    ...
    <link
      rel="stylesheet"
      href="./asset/fonts/fontawesome-free-5.15.4/css/all.min.css"
    />
  </head>
  <body>
    <!-- Modal Layout -->
    <div class="modal">
      ...
      <div class="modal_body">
        <div class="form-general">
          <form action="./test-be.php" class="form" method="POST" role="form">
            <div class="form-container">
              ...
              <div class="button form_control">
                ...
                <input type="submit" class="button button_general" value="Đăng Nhập"></input>
              </div>
            </div>
