...
<body>
    ...
    <script>
        ...
        function plusQty(id) {
            ...
            var item_price = document.getElementById("chechout_"+id).innerHTML
;
            ...
            inputQty.value = plus;
            $('#chechout_'+id).innerHTML = formatCash(newprice.toString());
            // qtyChange();
            return true;
        }
        ...
        function minusQty(id) {
            ...
            document.getElementById("chechout_"+id).innerHTML = formatCash(newprice.toString());
            // qtyChange();
            return true;
        }
