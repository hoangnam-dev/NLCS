...
<body>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td id="price_<?php echo $item['id']?>" class="cart-td"><span class="cart-item_prd-num"><?= number_format($item['price'], 0, ',', '.') ?></span></td>
                                                <td class="cart-td">
                                                ...
                                                <td id="checkout_<?php echo $item['id']; ?>" class="cart-td cart-item_prd-price"><?= $checkout_item ?></td>
    ...
    <script>
        ...
        function plusQty(id) {
            ...
            var item_checkout = document.getElementById("checkout_"+id)
;
            ...
            alert(formatCash(newprice.toString()));
            inputQty.value = plus;
            item_checkout.innerHTML = formatCash(newprice.toString());
            // qtyChange();
            return true;
        }
        ...
        function minusQty(id) {
            ...
            var item_price = document.getElementById("checkout_"+id).innerHTML
            ...
            document.getElementById("checkout_"+id).innerHTML = formatCash(newprice.toString());
            // qtyChange();
            return true;
        }
