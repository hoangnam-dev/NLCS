...
<body>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr>
                                                ...
                                                <td id="price_<?php echo $item['id']; ?>" class="cart-td cart-item_prd-price"><?= number_format($checkout_item, 0, ',', '.') ?><span>&nbsp;VNĐ</span></td>
                                                <td class="cart-td ">
    ...
    <script>
        ...
        function plusQty(id) {
            ...
            var item_price = document.getElementById("price_" + id);

            var quantity = parseInt(inputQty.value);
            var plus = qty_plus(quantity);
            var price = parseInt(item_price.value);
            alert(plus);
            alert(price);
            var newprice = sumItem(plus,price);
            inputQty.value = plus;
            item_price.innerText = newprice;
            qtyChange();
            return true;
        }
