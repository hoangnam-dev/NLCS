...
if (isset($_GET['order'])) {
    if (isset($_SESSION['cart']) && isset($_SESSION['user'])) {
        ...
        $sql_order = "INSERT INTO `dathang` (`SoDonDH`, `MSKH`, `MSNV`, `NgayDH`, `NgayGH`, `DiaChiGH`, `GhiChu`, `TrangThaiDH`) VALUES ($order_id, '$customer_id', NULL, '$day_order', NULL, '$order_address', '$order_note', '0');";
