                ...
                <div class="grid_row main_content cart_content">
                    <div class="grid_col-12 ctn-mb">
                        ...
                        <?php if (!empty($cart)) { ?>
                            ...
                            <form id="form-cart-item" method="POST" name="form-update">
                                            ...
                                            <tr>
                                                ...
                                                <td class="cart-td">
                                                    <div class="cart-item_qty">
                                                        ...
                                                        <input type="text" min="1" name="qty<?php echo $item['id']; ?>" class="qty_input" id="inputQty_<?php echo $item['id']; ?>" readonly value="<?php echo $item['quantity']?>" onchange="return qtyChange();">
                                                ...
                                                <td class="cart-td cart-item_prd-price"><?= number_format($checkout_item, 0, ',', '.') ?>&nbsp;VNĐ</td>
                                                <td class="cart-td ">
                    ...
                    <div class="cart_order-summary">
                        <form action="./process.php?order=order" method="POST" class="cart_order-summary-form" name="form-order">
                            ...
                            <div class="cart_confirm">
                                <input type="submit" name="submit" class="button button_general btn cart_confirm-btn <?php if (empty($cart)) {
                                                                                                                            echo "disable";
                                                                                                                        } ?>" value="Đặt hàng">
                            </div>
                        </form>
