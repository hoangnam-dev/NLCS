...
<body>
                            ...
                            ?>
                                    <div class="order-content">
                                        <div class="order_content-title">
                                            <!-- <span class="order-content_title">Ngày đặt hàng: <span class="order-date"><?php echo $order['NgayDH'] ?></span></span> -->
                                        ...
                                        <table class="order_body">
                                            ...
                                            <tr>
                                                <td colspan="2" class="order-td">
                                                    <div class="order-delivery">
                                                        Ngày giao hàng:
                                                        <span class="order-item_text item-delivery_time"><?php if ($order['TrangThaiDH'] == 0) {echo "Đang chờ xử lý";} else { ?></span>
                                                        <span id="delivery" class="order-item_text item-delivery_time"><?php echo $order['NgayGH']?></span>
                                                    <?php } ?>
                                                    </div>
                                                </td>
                                                <td class="order-td">
                            ...
                            ?>
                                    <div class="order-content">
                                        <div class="order_content-title processed-title">
                                            <span class="order-content_title">Ngày đặt hàng: <?php echo $order['NgayDH'] ?></span>
                                            <span class="order-content_title">Ngày đặt hàng: <span><?php echo $order['NgayDH'] ?></span></span>
                                        </div>
                                        <table class="order_body">
                                            <tr>
                                                <th class="order-th">Tên sản phẩm</th>
                                            ...
                                            <tr>
                                                <td colspan="2" class="order-td">
                                                    <div class="order-delivery">
                                                        Ngày giao hàng:
                                                        <span class="order-item_text item-delivery_time"><?php echo $order['NgayGH']?></span>
                                                    </div>
                                                </td>
                                                <td class="order-td">
                                                    <span class="order-item_text">Tổng tiền:</span>
    ...
    <script type="text/javascript">
        ...
        $(document).load(function() {
            var dbday = <?php echo $order['NgayDatHang'];?>;
            var date = new Date(dbday);
            var day = date.getDate();
            var month = date.getMonth()+1;
            var year = date.getFullYear();
            var orderDay = day+"-"+month+"-"+year;
            alert(dbday);
