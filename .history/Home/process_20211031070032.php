    ...
    if ($customer_name != "" && $customer_phone != "" && $customer_password != "" && $customer_repassword != "") {
        if ($customer_password == $customer_repassword) {
            ...
            if (mysqli_num_rows($rs) > 0) {
                ...
                $sql_insert = "INSERT INTO `khachhang` (`MSKH`, `HoTenKH`, `DiaChi`, `SoDienThoai`,`GioiTinh`,`Email`,`MatKhau`,`TrangThai`) VALUES (NULL, '$customer_name', '$customer_address', '$customer_phone', NULL, NULL,'$customer_password','1');";
    ...
    if (isset($_SESSION['cart']) && isset($_SESSION['user'])) {
        ...
        if ($rs_order) {
            ...
            foreach ($_SESSION['cart'] as $value) {
                ...
                $sql_detail = "INSERT INTO `chitietdathang` (`SoDonDH`, `MSSP`, `SoLuong`, `GiaDatHang`, `GiamGia`) VALUES ('$last_id', '$prd_id', '$prd_qty', '$prd_price', NULL); ";
