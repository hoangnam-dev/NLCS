            ...
            <div class="grid">
                    ...
                    <ul class="header_navbar-list">
                        ...
                        <?php } else { ?>
                            ...
                            <div id="modalLg" class="modal">
                                ...
                                <div class="modal_body">
                                    <div class="form-general">
                                        <form action="./process.php?action=login" class="form" method="POST" role="form">
                                            <div class="form-container">
                                                ...
                                                <div class="form_control">
                                                    ...
                                                    <input type="submit" onclick="return validateLg();" class="button button_general" value="Đăng Nhập"></input>
                                                </div>
                                            </div>
                            ...
                            <div id="modalRg" class="modal">
                                ...
                                <div class="modal_body">
                                    <div class="form-general">
                                        <form action="./process.php?action=register" class="form" method="POST" id="form-register">
                                            <div class="form-container">
                                                <div class="form_header">
                                                ...
                                                <div class="form_control">
                                                    ...
                                                    <input type="submit" class="button button_general lg_submit" onclick="return validateRg();" value="Đăng Ký"></input>
                                                </div>
                                            </div>
                                            <!-- <div class="form_socials">
                                                <a href="" class="button button-s button-icon button_socials-icon-fb">
                ...
                <div class="header-of-search">
                    <div onclick='window.open("./index.php", "_self")' class="header_logo">
                        <img class="logo_img" src="./asset/img/logo.png" alt="logo">
                    </div>
                    <div class="header_search">
                        <form action="./search.php" class="header_search" method="GET">
                            <input type="text" name="search" value="<?php if ($search != []) {
                            echo $search;} ?>" class="header_search-input" placeholder="Tìm kiếm...">
            ...
            <div class="grid">
                <nav class="header_menu">
                    <ul class="header_menu-list">
                        ...
                        <?php } ?>
                        <!-- <li class="header_menu-item">
                            <i class="hd_menu-icon "></i>
                            <a href="" class="header_menu-item-link">Khuyến mãi</a>
                        </li>
                        <li class="header_menu-item">
                            <i class="hd_menu-icon "></i>
                            <a href="" class="header_menu-item-link">Khuyến mãi</a>
                    ...
                    <!-- <ul class="header_menu-list">
                        <li class="header_menu-item">
                            <i class="hd_menu-icon fas fa-mobile-alt"></i>
                            <a href="./brand.php?brand" class="header_menu-item-link">Điện thoại</a>
                            <ul class="hm_sub-menu">
                                <li class="hm_sub-menu-item">
                                    <a href="" class="hm_sub-menu-item-link">Xiaomi</a>
                                </li>
                                <li class="hm_sub-menu-item">
                                    <a href="" class="hm_sub-menu-item-link">Vsmart</a>
                                </li>
                                <li class="hm_sub-menu-item">
                                    <a href="" class="hm_sub-menu-item-link">Oppo</a>
                                </li>
                                <li class="hm_sub-menu-item">
                                    <a href="" class="hm_sub-menu-item-link">Realme</a>
                                </li>
                            </ul>
                        </li>
                        <li class="header_menu-item">
                        ...
                        <li class="header_menu-item">
                            <i class="hd_menu-icon "></i>
                            <a href="" class="header_menu-item-link">Tablet</a>
                        </li>
                        <li class="header_menu-item">
                            <i class="hd_menu-icon "></i>
                            <a href="" class="header_menu-item-link">Phụ kiện</a>
                        </li>
                        <li class="header_menu-item">
                            <i class="hd_menu-icon "></i>
                            <a href="" class="header_menu-item-link">Khuyến mãi</a>
