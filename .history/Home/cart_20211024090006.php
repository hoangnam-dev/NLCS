                                            ...
                                            <tr>
                                                ...
                                                <td class="cart-td">
                                                    <div class="cart-item_qty">
                                                        ...
                                                        <input type="text" min="1" name="qty<?php echo $item['id']; ?>" class="qty_input" id="inputQty_<?php echo $item['id']; ?>" readonly value="<?php echo $item['quantity'] ?>" onchange="qtyChange()">
