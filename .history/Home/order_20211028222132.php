                                        ...
                                        <table class="order_body">
                                            ...
                                            <tr>
                                                <td colspan="2" class="order-td">
                                                    <div class="order-delivery">
                                                        Ngày giao hàng:
                                                        <span class="order-item_text item-delivery_time">Đang xử lý

                                                            <!-- <?php if ($order['TrangThaiDH'] == 0) {echo "Đang chờ xử lý";} else { ?> -->
                                                            </span>
                                        ...
                                        <table class="order_body">
                                            ...
                                            <tr>
                                                <td colspan="2" class="order-td">
                                                    <div class="order-delivery">
                                                        Ngày giao hàng:
                                                        <span class="order-item_text item-delivery_time"></span>
                                                    </div>
                                                </td>
                                                <td class="order-td">
                                                    <span class="order-item_text">Tổng tiền:</span>
