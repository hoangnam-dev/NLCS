                                        ...
                                        <form action="./process.php?action=login" class="form" method="POST" role="form">
                                            <div class="form-container">
                                                ...
                                                <div class="form_control">
                                                    ...
                                                    <input type="submit" name="submit" onclick="return validateLg();" class="button button_general" value="Đăng Nhập"></input>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                        ...
                                        <form action="./process.php?action=register" class="form" method="POST" id="form-register">
                                            <div class="form-container">
                                                ...
                                                <div class="form_control">
                                                    ...
                                                    <input type="submit" name="submit" class="button button_general lg_submit" onclick="return validateRg();" value="Đăng Ký"></input>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
