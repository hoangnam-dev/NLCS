                ...
                <div class="grid_row main_content">
                            ...
                            <ul class="category-list">
                                <?php
                                    ...
                                    <li class="category-item">
                                        <a href="./category.php?brand=<?php echo $brands['MSTH'];?>" class="category_link <?php if($brands['MSTH'] == $brand_id){echo 'category_item-active';}?>"><?php echo $brands['TenTH']; ?></a>
                                    </li>
                                    <?php }?>
                            </ul>
                        </nav>
                    ...
                    <div class="grid_col-9 ctn-box ctn-mb">
                        ...
                        <div class="ctn_filter">
                            ...
                            <button class="button ctn_btn" onclick='location.assign("./hot_category.php?brand=<?php echo  $brand["MSTH"];?>&hot")'>Phổ biến</button>
                            ...
                            <!-- <div class="grid_col-4">
                                        <div  class="product-item">
                                            <a href="#" class="product-img">
                                                <div class="product-item_img" style="background-image: url('./asset/img/Apple/iphone-12-256GB.jpg');"></div>
                                            </a>
                                            <h3 class="product-item_name">Iphone 12 256GB Chính hãng VN/A</h3>
                                            <div class="product-item_price">
                                                <span class="product-item_price-old">23.999.999đ</span>
                                                <span class="product-item_price-new">20.999.999đ</span>
                                            </div>
                                            <span class="product-item_description">Màn hình 6.5', 6GB, 256GB</span>
                                            <div class="product-item_rating">
                                                <i class="product-item_rating-check fa fa-star"></i>
                                                <i class="product-item_rating-check fa fa-star"></i>
                                                <i class="product-item_rating-check fa fa-star"></i>
                                            ...
                                            <div class="product-item_oder">
                                                <a href="#" class="button button_general btn product-item_oder-btn">Thêm vào giỏ hàng</a>
                                            </div>
                                            <div class="product-item_sale-off">
                                                <span class="product-item_sale-off-label">GIẢM</span>
                                                <span class="product-item_sale-off-precent">10%</span>
