            ...
            <div class="grid">
                <div class="grid_row main_content cart_content">
                    ...
                    <div class="cart_order-summary">
                        <form id="form-order" method="POST" class="cart_order-summary-form" name="form-order">
                            ...
                            <div class="order-summary-content">
                                ...
                                <div class="order-summary-input">
                                    ...
                                    <input type="text" class="order-summary_input summary_input" name="customer_address" value="<?= $user['DiaChi'] ?>">
                                </div>
                                <div class="order-summary-input">
