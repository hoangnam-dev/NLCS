                ...
                <div class="grid_row main_content order_content">
                    <div class="grid_col-12 ctn-mb">
                        ...
                        <div id="waiting" class="tabcontent active">
                            <h3 class="tabcontent-header">Đơn hàng chưa xử lý</h3>
                            <?php
                                    ...
                                    <div class="order-content">
                                        ...
                                        <table class="order_body">
                                            ...
                                            while ($detail = mysqli_fetch_array($rs_detail)) {
                                                ...
                                                $detail_id = $detail['MaSP'];
                                                $sql_prd = "SELECT * FROM SanPham WHERE SanPham.MaSP = '$detail_id';";
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="order-td">
                                                            <a href="#" class="cart-item_img">
                                                                <img class="cart_img" src="../img_upload/<?php echo $prd['AnhSP']; ?>">
                                                            </a>
                                                        </td>
                                                        <td class="order-td">
