    ...
    if ($customer_name != "" && $customer_phone != "" && $customer_password != "" && $customer_repassword != "") {
        if ($customer_password == $customer_repassword) {
            ...
            if (mysqli_num_rows($rs) > 0) {
                ...
                $sql_insert = "INSERT INTO `khachhang` (`$customer_id`, `HoTenKH`, `DiaChi`, `SoDienThoai`,`GioiTinh`,`Email`,`MatKhau`,`TrangThai`) VALUES (NULL, '$customer_name', '$customer_address', '$customer_phone', NULL, NULL,'$customer_password','1');";
