                            ...
                            <table id="staff-list" class="main-table_content">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="btn-edit">
                                            <a href="staff_upd.php?id=<?php echo $staff['MSNV']; ?>" class="button-edit btn-update">Chi tiết</a>
                                            <button class="button-edit btn-delete" value="<?php echo $staff['MSNV'];?>">Xóa</button>
                                        </td>
                                    </tr>
                                    <?php $i++;}?>
                                </tbody>
