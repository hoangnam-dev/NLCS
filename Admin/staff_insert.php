...
<body>
        ...
        <div class="grid_full-width wrapper">
            ...
            <div class="container">
                ...
                <div class="main_insert-content">
                        <form id="form-ins-staff" class="staff_insert-form" method="POST" role="form">
                        <div class="main_form">
                            <div class="main-form_left">
                                ...
                                <div class="form-input">
                                    <label class="form_label">Chức vụ:</label>
                                    <select name="staff_jobtitle" id="staff_jobtitle" class="form_input">
                            ...
                            <div class="form-input">
                                ...
                                <div class="form-input">
                                    ...
                                    <input id="staff_password" type="password" class="form_input" name="staff_password">
                                    <span id="error-staff_password" class="error-message"></span>
                                </div>
                                <div class="form-input">
                                    <label class="form_label">Nhập lại mật khẩu(*):</label>
                                    <input id="staff_repassword" type="password" class="form_input" name="staff_repassword">
    ...
    <script>
        ...
        function validateStaff() {
            ...
            var repassword =$("#staff_repassword").val();
